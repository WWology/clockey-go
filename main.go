...
func main() {
	...
	if err = b.SetupBot(h, bot.NewListenerFunc(b.OnReady), bot.NewListenerFunc(b.OnCommand), bot.NewListenerFunc(b.OnModal), bot.NewListenerFunc(b.OnMessageCreate)); err != nil {
